...
/**
 * Parses and validates the request body against the specified Zod schema.
 *
 * @template T - The Zod schema type.
 * @param req - Express Request object containing the body to be validated.
 * @param schema - The Zod schema for validating the body.
 * @param options - Optional parameter. If omitted or { safe: false }, throws on validation failure.
 * @returns The validated body of type inferred from the schema.
 ...
 * // In express handler:
 * const parsed = readValidatedBody(req, schema);
 * // Throws error if invalid
 * ```
 */
export function readValidatedBody<T extends z.ZodTypeAny>(
  req: Request,
  schema: T,
  options?: { safe?: false },
): z.infer<T>;
...
/**
 * Parses and safely validates the request body against the specified Zod schema.
 *
 * @template T - The Zod schema type.
 * @param req - Express Request object containing the body to be validated.
 * @param schema - The Zod schema for validating the body.
 ...
 * const schema = z.object({ name: z.string() });
 * // In express handler:
 * const safeParsed = readValidatedBody(req, schema, { safe: true });
...
/**
 * Parses and validates the request body against the specified Zod schema, returning either result or throwing error.
 *
 * @template T - The Zod schema type.
 * @param req - Express Request object containing the body to be validated.
 * @param schema - The Zod schema for validating the body.
